...
export default function AwardWinnersCard({
  ...
  // ✅ Helper to format numbers nicely (e.g., 1,200 → 1.2K)
  ...
  return (
    <Card className="w-full max-w-6xl mx-auto rounded-xl shadow-md hover:shadow-lg transition-shadow duration-300 bg-white dark:bg-gray-900 overflow-hidden animate-fadeIn">
      ...
      {/* Content */}
      <CardContent className="px-3 sm:px-6 lg:px-8 py-6">
        {isLoading ? (
              ...
              <Table className="min-w-full border-collapse border border-gray-100 dark:border-gray-800">
                <TableHeader className="bg-gray-50 dark:bg-gray-800/60">
                  <TableRow>
                    <TableHead
                      scope="col"
                      className="text-left font-semibold tracking-wide text-gray-700 dark:text-gray-300 whitespace-nowrap uppercase text-xs sm:text-sm"
                    >
                      Award Category
                    </TableHead>
                    <TableHead
                    ...
                    <TableHead
                      scope="col"
                      className="text-right font-semibold tracking-wide text-gray-700 dark:text-gray-300 whitespace-nowrap uppercase text-xs sm:text-sm"
                    >
                      Votes
                    </TableHead>
                  </TableRow>
