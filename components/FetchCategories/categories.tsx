...
// Fetch category details (nominees + votes)
...
export default function Categories({ searchQuery = "" }: CategoriesProps) {
  ...
  return (
    <section
      aria-labelledby="categories-grid"
      className="w-full py-10 px-4 sm:px-6 lg:px-8"
    >
      <div
        id="categories-grid"
        className="max-w-7xl mx-auto grid gap-8 sm:grid-cols-1 md:grid-cols-2 xl:grid-cols-3"
      >
        {isLoading
